                    ...
                    if ( target !== null ) {
                        ...
                        if ( target.closest('.ec-option-url-group') ) {
                            ...
                            Classes.Timer.schedule_event('update_url', (): void => {
                                ...
                                // Get the option url
                                let option_url: HTMLElement | null = target.closest('.ec-option-url-group');

                                // Get input
                                let input: HTMLCollectionOf<HTMLInputElement> | undefined = option_url!.getElementsByTagName('input');
                                ...
                                if ( input !== undefined ) {
                                    ...
                                    if ( value !== undefined ) {
                                        ...
                                        if ( is_url_valid(value) ) {
                                            ...
                                            // Get the option name
                                            let option_name: string | null | undefined = option_url!.closest('li')?.getAttribute('data-option');
                                                ...
                                                if ( element_id ) {
                                                    ...
                                                    if ( iframe ) {
                                                        ...
                                                        if ( iframeDocument !== null ) {
                                                            ...
                                                            let element_name: string | null = target.closest('.ec-option-url-group')!.getAttribute('data-element')?target.closest('.ec-option-url-group')!.getAttribute('data-element'):'';
