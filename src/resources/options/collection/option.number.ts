    ...
    export class Number extends AbstractOptions.Abstracts.Options {
        ...
        prepare_property(params: params_type, option: option_number_type): option_property_type {
            ...
            if ( typeof option.name === 'undefined' ) {
                ...
                // Set unit
                let unit: string = (typeof option.unit !== 'undefined')?option.unit:'';
                ...
                target: (e: MouseEvent): void => {
                    ...
                    if ( target !== null ) {
                        ...
                        if ( target.closest('.ec-composer-element-options') && target.closest('.ec-option-input-buttons-group') && (target.getAttribute('type') === 'number') ) {
                            ...
                            let buttons_group: HTMLElement | null = target.closest('.ec-option-input-buttons-group');

                            // Get input
                            let input: HTMLCollectionOf<HTMLInputElement> | undefined = buttons_group?.getElementsByTagName('input');
                            ...
                            if ( input !== undefined ) {
                                ...
                                if ( value !== undefined ) {
                                    ...
                                    // Get the option name
                                    let option_name: string | null | undefined = buttons_group?.closest('li')?.getAttribute('data-option');
                                    ...
                                    if ( option_name ) {
                                        ...
                                        // Get the device type
                                        let device = buttons_group?.closest('.ec-sections')!.getAttribute('data-scope') as string;

                                        // Get property
                                        let property: option_property_type = this.get_property(Resources.Options.Number.saved_options[option_name + '_' + element_name]);                                        
                                        ...
                                        if ( (typeof Resources.Options.Number.saved_options[option_name + '_' + element_name] !== 'undefined') && (property !== undefined) && (property !== null) ) {
                                            ...
                                            // Get the unit
                                            let aunit: string = value.replace(anumber.toString(), '')?value.replace(anumber.toString(), ''):Resources.Options.Number.saved_options[option_name + '_' + element_name].unit;
                                                ...
                                                if ( iframe ) {
                                                    ...
                                                    if ( iframeDocument !== null ) {
                                                        ...
                                                        if ( style !== null ) {
                                                            ...
                                                            let style_content: string = update_property_value(sheet, element_id, element_name, property_name, anumber + aunit, device);
                                            ...
                                            if ( iframe ) {
                                                ...
                                                if ( iframeDocument !== null ) {
                                                    ...
                                                    if ( style !== null ) {
                                                        ...
                                                        // Update a property value
                                                        let style_content: string = update_property_value(sheet, '', element_name, property_name, anumber + aunit, device);
                                    ...
                                    if ( option_name ) {
                                        ...
                                        if ( (typeof Resources.Options.Number.saved_options[option_name + '_' + element_name] !== 'undefined') && (property !== undefined) && (property !== null) ) {
                                            ...
                                            if ( target.classList.contains('ec-option-input-button-increase') ) {
                                                ...
                                                // New value
                                                let new_value: number = anumber = (anumber + 1);
