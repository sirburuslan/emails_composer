...
const set_opacity = (params: any, r: number, g: number, b: number, a?: number): void => {
    ...
    // Get the opacity
    let opacity: HTMLElement = params.selector.getElementsByClassName('ec-option-color-opacity-filter')[0];
...
const draw_gradient = (params: any, rgb_color: any): void => {
    ...
    // Convert rgb to hsl
    let hsl: any = convert_rgb_to_hsl(rgb_color['r'], rgb_color['g'], rgb_color['b']);

    // Get the gradient element
    let gradient: any = params.selector.getElementsByClassName('ec-option-color-gradient-selector')[0];

    // Get the gradient 2d context
    let gradient_2d: any = gradient.getContext('2d');
...
const draw_filter = (params: any): void => {
    ...
    let filter: any = params.selector.getElementsByClassName('ec-option-color-gradient-filter')[0];

    // Get the filter 2d context
    let filter_2d: any = filter.getContext('2d');
...
const get_gradient_color = (e: any, params: any): void => {
    ...
    // Get the gradient
    let gradient: any = e.target.closest('.ec-option-color-gradient-selector');
    ...
    img.onload = (): void => {
        ...
        // Get the image data
        let image_data: any = canvas.getContext('2d').getImageData(e.offsetX, e.offsetY, 1, 1).data;

        // Get the color input
        let input: any = params.selector.getElementsByClassName('ec-option-color-input')[0];
...
const get_filter_color = (e: any, params: any): void => {
    ...
    // Get the filter 2d context
    let filter_2d: any = e.target.closest('.ec-option-color-gradient-filter').getContext('2d');
